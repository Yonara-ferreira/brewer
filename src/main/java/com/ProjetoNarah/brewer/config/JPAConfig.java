...
public class JPAConfig {
	...
	public DataSource dataSouce() {
		...
		dataSourceLookup.setResourceRef(true); // Procura conf. dentro do servidor (META-INF/context.xml)
	...
	public EntityManagerFactory entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
		...
		factory.setPackagesToScan(Cerveja.class.getPackage().getName());  // Usando a classe para mesmo que houver refatoração, nao ocorra problemas. 
